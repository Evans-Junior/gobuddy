...
try {
    ...
    $tripCreatorQuery = "SELECT DISTINCT u.UserID, u.Username
                         ...
                         WHERE tr.Status = 'Accepted' or tr.Status = 'Completed' or tr.Status = 'Deleted'";
    ...
    $acceptedRequestsQuery = "SELECT DISTINCT u.UserID, u.Username
                              ...
                              WHERE tr.Status = 'Accepted' or tr.Status = 'Completed' or tr.Status = 'Deleted' AND tr.TripID IN (
                                  SELECT t.TripID
                                  FROM Trips t
                                  WHERE t.UserID = ?
                              )";
